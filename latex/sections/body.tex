...
\begin{equation}
    \begin{aligned}
        A_{n-1}B_{n-1} &= \frac{A_{i}B_{i}}{\sqrt{5}} \\
        B_{n-1}C_{n-1} &= \frac{B_{i}C_{i}}{\sqrt{5}} \\
        A_{n-1}C_{n-1} &= \frac{A_{i}C_{i}}{\sqrt{5}}
    \end{aligned}
\end{equation}
...
\begin{enumerate}
    \item Draw line $A_{0}A_{1}$, $A_{1}A_{2}$, $A_{2}A_{3}$ \ldots\ for all $A_{i}A_{n + 1}$
    \item Draw line $B_{0}B_{1}$, $B_{1}B_{2}$, $B_{2}B_{3}$ \ldots\ for all $B_{i}B_{n + 1}$
    \item Draw line $C_{0}C_{1}$, $C_{1}C_{2}$, $C_{2}C_{3}$ \ldots\ for all $C_{i}C_{n + 1}$
\end{enumerate}
